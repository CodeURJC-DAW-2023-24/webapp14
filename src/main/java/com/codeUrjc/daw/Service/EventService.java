        ...
        public class EventService {
            ...
            public void init() throws IOException {
                if(events.count() == 0) { // Verify if the data base is empty
                    ...
                    Resource resource = new ClassPathResource("static/img/apple-icon.png");
                    BlobProxy.generateProxy(resource.getInputStream(), resource.getFile().length());

                    Optional<Event> event = events.findById(1L);
